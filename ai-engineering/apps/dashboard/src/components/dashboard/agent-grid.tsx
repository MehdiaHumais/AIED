...
const agents = [
  ...
  { id: "backend-helper", name: "Backend Helper", role: "Helper", status: "idle", department: "Development" },
  { id: "frontend-engineer", name: "Frontend Engineer", role: "Frontend", status: "idle", department: "Development" },
  { id: "frontend-helper", name: "Frontend Helper", role: "Helper", status: "idle", department: "Development" },
  { id: "qa-engineer", name: "QA Engineer", role: "Quality", status: "idle", department: "Quality" },
  { id: "qa-helper", name: "QA Helper", role: "Helper", status: "idle", department: "Quality" },
  ...
  { id: "deployment-helper", name: "Deployment Helper", role: "Helper", status: "idle", department: "DevOps" },
